...
const capabilities = [
  ...
  },
  {
    ...
    body:
      "Transforming raw data into trusted, evidence-grade intelligence through a Health Data Trust<sup>SM</sup> that supports confident decisions, accountability, and measurable outcomes.",
    icon: (
      <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
